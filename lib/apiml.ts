...
export class ApimlConnector {
  ...
  private eurekaOverrides: any;
  private zluxServerEurekaClient: any;
  private vipAddress: string;

  constructor({ hostName, httpPort, httpsPort, apimlHost, apimlPort, tlsOptions, eurekaOverrides }: any) {
    Object.assign(this, {
      hostName, httpPort, httpsPort, apimlHost,
      apimlPort, tlsOptions, eurekaOverrides
    });
    this.vipAddress = hostName;
  }
